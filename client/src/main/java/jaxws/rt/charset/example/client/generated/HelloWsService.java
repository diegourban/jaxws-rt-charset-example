...
@WebServiceClient(
        name = "HelloWsService",
        targetNamespace = "http://server.example.charset.rt.jaxws/",
        wsdlLocation = "http://localhost:7001/charset-example?wsdl")
public class HelloWsService extends Service {
    ...
    private final static QName HELLOWSSERVICE_QNAME = new QName("http://server.example.charset.rt.jaxws/", "HelloWsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7001/charset-example?wsdl");
    ...
    public HelloWs getHelloWsPort() {
        return super.getPort(new QName("http://server.example.charset.rt.jaxws/", "HelloWsPort"), HelloWs.class);
    }
    ...
    public HelloWs getHelloWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.example.charset.rt.jaxws/", "HelloWsPort"), HelloWs.class, features);
    }
